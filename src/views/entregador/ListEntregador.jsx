...
class ListEntregador extends React.Component {
  ...
  remover = async () => {
    await axios
      .delete("http://localhost:8080/api/entregador/" + this.state.idRemover)
      .then((response) => {
                ...
                <Table.Body>
                  {this.state.listaEntregadores.map((entregador) => (
                    <Table.Row key={entregador.id}>
                      ...
                      <Table.Cell>
                        {this.formatarData(entregador.dataNascimento)}
                      </Table.Cell>
                      ...
                      <Table.Cell textAlign="center">
                        <Button
                          ...
                          onClick={(e) =>
                            this.exibirDetalheEntregador(entregador.id)
                          }
                        />{" "}
                        &nbsp;
                        <Button
                  ...
                  <List.Item>
                    ...
                    <List.Content>
                      <List.Description>
                        ...
                        {this.formatarData(
                          this.state.entregadorObj.dataNascimento
                        )}
                      </List.Description>
                    </List.Content>
                  </List.Item>
                  ...
                  <List.Item>
                    ...
                    <List.Content>
                      <List.Description>
                        ...
                        {this.state.entregadorObj.enderecoRua},{" "}
                        {this.state.entregadorObj.enderecoNumero},{" "}
                        {this.state.entregadorObj.enderecoBairro},{" "}
                        {this.state.entregadorObj.enderecoComplemento},{" "}
                        {this.state.entregadorObj.enderecoCidade} -{" "}
                        {this.state.entregadorObj.enderecoUf} - CEP:{" "}
                        {this.state.entregadorObj.enderecoCep}
                      </List.Description>
                    </List.Content>
                  </List.Item>
                  <List.Item>
                    ...
                    <List.Content>
                      <List.Description>
                        <strong>Ativo:</strong> &nbsp; &nbsp;
                        {this.state.entregadorObj.ativo === true && <>Sim</>}
                        {this.state.entregadorObj.ativo === false && <>Não</>}
                      </List.Description>
                    </List.Content>
                  </List.Item>
                </List>
